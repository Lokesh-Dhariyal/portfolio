...
function Contact() {
  return (
    <div id='contact' className='text-white w-full h-233 lg:h-fit -z-10 inset-0
      ...
      <div className='w-28/29 lg:w-3/4 mx-auto mt-22 lg:h-2/3'>
          <strong className=' opacity-20 text-white'>#CONTACT</strong>
          <ContactMe/>
      </div>
        <Connect/>
        <div className='w-full lg:w-1/3 h-10 lg:mb-5 lg:mt-5 lg:mx-auto pt-5 lg:pt-1 font-mono text-center text-[#c4c4c4] text-xs lg:text-lg opacity-60'>
