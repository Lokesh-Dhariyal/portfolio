  ...
  return (
    <div id='start' className='text-white w-10/11 h-215 lg:w-3/4 lg:h-dvh pt-30 lg:pt-60 mx-auto'>
      ...
      <span className='flex flex-wrap'>
        ...
        <div className='lg:text-4xl text-2xl mb-7 flex'>I am a<TextTransition springConfig={presets.wobbly} className='flex text-xl lg:text-3xl font-azeeb text-blue-100 pt-1 mx-2'>{dev[change%dev.length]}</TextTransition></div>
