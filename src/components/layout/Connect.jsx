function Connect() {
  ...
  return (
    <div className='lg:w-1/2 h-20 lg:h-35 flex mx-auto'>
        <div className='border-2 border-blue-900 bg-[#101420] text-[#c4c4c4] rounded-3xl text-center font-mono text-xl lg:text-3xl pt-1 lg:pt-4 mx-5 w-1/3 h-1/2 lg:h-1/2 my-auto'>Connect At</div>
        <div className='lg:mx-5 w-3/6 lg:w-3/5 h-1/2 lg:h-1/2 my-auto flex justify-evenly' >
